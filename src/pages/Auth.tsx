    ...
    <div className="min-h-screen bg-background bg-grid flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="p-6 rounded-3xl border-2 border-border bg-card/95 backdrop-blur-md kawaii-shadow">
          ...
          {mode !== "forgot" && (
            <>
              <Button
                ...
                variant="outline"
                className="w-full rounded-xl font-bold mb-4"
              >
          ...
          <form onSubmit={mode === "login" ? handleEmailLogin : mode === "signup" ? handleEmailSignup : handleForgotPassword}>
            {mode === "signup" && (
              <div className="mb-3">
                <Label htmlFor="name" className="text-xs font-bold text-muted-foreground">Display Name</Label>
          ...
          <div className="mt-4 text-center text-xs space-y-1">
            {mode === "login" && (
              <>
                <button onClick={() => setMode("forgot")} className="text-primary hover:underline font-bold block mx-auto">
                  Forgot password?
                </button>
